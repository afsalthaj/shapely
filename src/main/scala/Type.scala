...
object TypeClass extends App {
  ...
  inline implicit def deriveF1[F[_], A, A1, L1 <: String](implicit f: InvariantAp[F], ev1: F[A1], ev2: TypeClassInspect[F, ignore]): Lazy[F, CaseClass1[A, A1, L1]] = {
    val annotations = Annotation.annotationOf[A1, ignore].headOption
    println(annotations)
